...
<div class="row-fluid">
    <div class="block span6">
        <a href="#tablewidget" class="block-heading" data-toggle="collapse">Últimos Cadastros<span class="label label-warning">+10</span></a>
        <div id="tablewidget" class="block-body collapse in">
            ...
            <p><a href="<?php echo site_url(); ?>adm/clientes/listar">Mais...</a></p>
        </div>
    </div>
    <div class="block span6">
